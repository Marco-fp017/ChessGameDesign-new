...
public class Board {
    ...
    public Board(int rows, int columns) {
        if(rows < 1 || columns < 1) throw new BoardException("Error creating board! There must be at least 1 row ant 1 column");
        this.rows = rows;
    ...
    private boolean positionExists(int row, int column) {
        ...
        //se pelo menos uma comparação for falsa, o método irá retornar falso
    }
